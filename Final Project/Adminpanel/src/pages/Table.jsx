...
function Table() {
  ...
  const getData = async () => {
    const res = await axios.get(
      `https://topstask-default-rtdb.firebaseio.com/user.json`
    );
    console.log(res);
    if (res.status === 200) {
      setData(res.data);
  ...
  const deleteData = async (id) => {
    ...
    const res = await axios.delete(
      `https://topstask-default-rtdb.firebaseio.com/user/${id}.json`
    );
    console.log(res);
    if (res.status === 200) {
      swal({
  ...
  const updateHandle = async (e) => {
    const res = await axios.patch(
      `https://topstask-default-rtdb.firebaseio.com/user/${userID}.json`,
      formvalue1
    );
    if (res.status === 200) {
